...
+"<p>SOUTHERN CALIFORNIA ORACLE</p>",

"The most merciful thing in the world ... is the inability of the human"
+" mind to correlate all its contents."
+"<p>H P LOVECRAFT</p>",

"<p>Take what you can use and let the rest go by </p> KEN KESEY",
"<p>Its not the size of the ship, its the size of the waves </p> LITTLE RICHARD",
"I never loved another person the way I loved myself <p>MAE WEST</p>",

"Nothing is true. Everything is permitted."
+"<p>HASSAN I SABBAH</p>",

"When choosing between two evils I always like to take the one Ive never tried before."
+"<p>MAE WEST</p>",
...
+"<p>SOUTH AFRICAN SAYING</p>",

"Use it up ... Wear it out."
+" Make it do ... Or do without."
+"<p>US WORLD WAR II MESSAGE</p>",
...
"<s>You smash it</s> and Ill build around it."
+"<p>JOHN LENNON</p>",
...
+"<p>BULLWINKLE MOOSE</p>",

"The mistake you make is in trying to figure it out."
+"<p>TENESSEE WILLIAMS</p>",
...
"<p>Law of Computability Applied to Social Sciences</p>"
...
+"<p>ROBERT D SPRECHT (RAND CORP)</p>",
...
"<p>Zimmerman's Law of Complaints:</p>"
...
+"<p>cartoon by S. Harris </p>",

"<p>The Swartzberg Test:</p>"
...
+"<p>upon it and he'll have to touch it to be sure.</p>",
...
"<p>Canada Bill Jones' Motto</p>"
+"     It's morally wrong to allow suckers to keep their money.",


"<p>Canada Bill Jones' Supplement</p>"
+"     A Smith & Wesson beats four aces.",


"<p>Clarke's Third Law</p>"
...
"<p>Hoare's Law of Large Programs</p>"
...
"<p>Iron Law of Distribution</p>"
+"     Them what hasgets.",

"<p>John's Axiom</p>"
+"     When your opponent is down, kick him.",

"<p>John's Collateral Corollary</p>"
+"     In order to get a loan, you must first prove that you don't need it.",

"<p>Johnson-Laird's Law</p>"
...
"<p>Law of Selective Gravitation</p>"
...
"<p>O'Tooles's Commentary on Murphy</p>"
+"     He was an optimist.",
